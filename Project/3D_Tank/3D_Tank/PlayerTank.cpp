...
PlayerTank::PlayerTank()
	:mRotateSpd(60.0f),mMoveSped(2.0f),mBatteryRotSpd(1.0f), mBatteryMaxPitch(10.0f), mBatteryMinPitch(-30.0f),
...
void PlayerTank::move(Vector3 value)
{
	...
	SoundManager::sGetInstance()->setValume(0.2, tankSound->mChannel);
	mBatteryRotSpd = 1.0f;
}
